import { Box, Button, Typography, Grid, TextField, Select, MenuItem, FormControl, InputLabel, Divider } from "@mui/material";
    ...
    return (
        <Grid container spacing={3} justifyContent="space-around" p={3}>
            ...
            <Grid item xs={12} sm={6} md={3}>
                ...
                >
                    <Typography variant="h6" style={{ marginBottom: '20px' }}>Cambiar rol de usuario</Typography>
                    <TextField
            ...
            <Grid item xs={12} sm={6} md={3}>
                ...
                >
                    ...
                    <Button variant="contained" color="primary" onClick={handleCoffeeOrder}>
                        Pedir
                    </Button>
                </Box>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={3}>
                ...
                >
                    ...
                    <Button variant="contained" color="error" style={{ marginBottom: '10px' }}>
                        Romper
                    </Button>
